...
class MovingCars(Task):
    ''' simulates moving cars '''
...
if __name__ == '__main__':  # test only
    ...
    street_with_cars = [cell for cell in Cell.__subclasses__() if cell in [Street, Car]]
    cell_names = [cell.__name__ for cell in all_cells]
    print('all cells:', *cell_names)
    # generate random cells
    cells = [[random.choice(street_with_cars)(row, col)
